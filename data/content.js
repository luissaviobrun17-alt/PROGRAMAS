        ...
        lessons:[
          {
            ...
            vocabulary:[
              ...
              {word:'My name is...',ipa:'/maɪ neɪm ɪz/',pt:'Meu nome é...',ex:'My name is Vinicius.',exPt:'Meu nome é Arthur.'},
            ...
            dialogue:[
              ...
              {speaker:'carolina',text:'Hi there! My name is leticia. What\'s your name?',textPt:'Oi! Meu nome é leticia. Qual é o seu nome?'},
              {speaker:'vinicius',text:'I\'m Arthur. Nice to meet you, leticia!',textPt:'Eu sou Arthur. Prazer em conhecer você, leticia!'},
              {speaker:'carolina',text:'Nice to meet you too! How are you today?',textPt:'Prazer em conhecer você também! Como você está hoje?'},
              {speaker:'vinicius',text:'I\'m great, thank you! Would you like a coffee?',textPt:'Estou ótimo, obrigado! Você gostaria de um café?'},
              {speaker:'carolina',text:'Yes, please! A cappuccino, please.',textPt:'Sim, por favor! Um cappuccino, por favor.'}
            ],
            pronunciation:[
          ...
          },
          {
            ...
            dialogue:[
              {speaker:'carolina',text:'So, where are you from?',textPt:'Então, de onde você é?'},
              {speaker:'vinicius',text:'I\'m from London, but I live in São Paulo now.',textPt:'Sou de Londres, mas moro em São Paulo agora.'},
              {speaker:'carolina',text:'Oh, nice! I\'m from Rio de Janeiro. I\'m Brazilian.',textPt:'Ah, legal! Sou do Rio de Janeiro. Sou brasileira.'},
              {speaker:'vinicius',text:'Do you speak English at home?',textPt:'Você fala inglês em casa?'},
              {speaker:'carolina',text:'No, I speak Portuguese at home. But I study English every day!',textPt:'Não, falo português em casa. Mas estudo inglês todo dia!'},
        ...
        lessons:[
          {
            ...
            dialogue:[
              ...
              {speaker:'carolina',text:'Of course! For how many nights?',textPt:'Claro! Por quantas noites?'},
              {speaker:'vinicius',text:'Three nights. From Monday to Thursday.',textPt:'Três noites. De segunda a quinta.'},
              {speaker:'carolina',text:'Perfect. A single room is eighty-five dollars per night.',textPt:'Perfeito. Um quarto de solteiro é oitenta e cinco dólares por noite.'},
              {speaker:'vinicius',text:'How much is that in total?',textPt:'Quanto é isso no total?'},
              {speaker:'carolina',text:'That\'s two hundred and fifty-five dollars total.',textPt:'São duzentos e cinquenta e cinco dólares no total.'}
            ],
            pronunciation:[
        ...
        lessons:[
          {
            ...
            dialogue:[
              {speaker:'carolina',text:'Good evening! Table for two, please.',textPt:'Boa noite! Mesa para dois, por favor.'},
              {speaker:'vinicius',text:'Right this way. Here\'s the menu.',textPt:'Por aqui, por favor. Aqui está o cardápio.'},
              {speaker:'carolina',text:'Thank you! I\'d like a glass of water to start.',textPt:'Obrigada! Eu gostaria de um copo de água para começar.'},
              {speaker:'vinicius',text:'Of course. Are you ready to order?',textPt:'Claro. Você está pronta para pedir?'},
              {speaker:'carolina',text:'Yes! I\'d like the grilled chicken with salad, please.',textPt:'Sim! Eu gostaria do frango grelhado com salada, por favor.'},
              {speaker:'vinicius',text:'Excellent choice! And for dessert?',textPt:'Excelente escolha! E de sobremesa?'},
              {speaker:'carolina',text:'I\'ll have the chocolate cake. It looks delicious!',textPt:'Vou querer o bolo de chocolate. Parece delicioso!'}
            ],
            pronunciation:[
      ...
      {id:'a2m1',title:'Travel & Transportation',titlePt:'Viagens e Transporte',icon:'✈️',theme:'Planejando uma viagem internacional',
        lessons:[{
          ...
          dialogue:[
            ...
            {speaker:'carolina',text:'Gate 12. It\'s boarding in twenty minutes.',textPt:'Portão 12. O embarque começa em vinte minutos.'},
            {speaker:'vinicius',text:'Thank you! Do I need to show my passport here?',textPt:'Obrigado! Preciso mostrar meu passaporte aqui?'},
            {speaker:'carolina',text:'Yes, please. And your boarding pass too.',textPt:'Sim, por favor. E seu cartão de embarque também.'}
          ],
      ...
      {id:'b1m1',title:'Business English',titlePt:'Inglês para Negócios',icon:'💼',theme:'Reunião de negócios internacional',
        lessons:[{
          ...
          dialogue:[
            ...
            {speaker:'carolina',text:'The first item is the Q3 revenue report. Revenue increased by fifteen percent.',textPt:'O primeiro item é o relatório de receita do Q3. A receita aumentou quinze por cento.'},
            ...
            {speaker:'carolina',text:'Of course. The main driver was our new product launch in Southeast Asia.',textPt:'Claro. O principal fator foi o lançamento do nosso novo produto no Sudeste Asiático.'}
          ],

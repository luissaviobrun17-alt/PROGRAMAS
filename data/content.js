        ...
        lessons:[
          {
            ...
            instructor:'arthur',
            intro:{
              text:"Welcome to FREE WORLD! I'm Arthur, your English instructor. Today, we're starting with the most important thing in any language: how to greet people and introduce yourself. Let's imagine you just walked into a modern café in São Paulo and you need to order in English.",
              textPt:"Bem-vindo ao FREE WORLD! Eu sou o Arthur, seu instrutor de inglês. Hoje, vamos começar com a coisa mais importante em qualquer idioma: como cumprimentar pessoas e se apresentar. Vamos imaginar que você acabou de entrar em uma cafeteria moderna em São Paulo e precisa pedir em inglês.",
            ...
            vocabulary:[
              ...
              {word:'My name is...',ipa:'/maɪ neɪm ɪz/',pt:'Meu nome é...',ex:'My name is Arthur.',exPt:'Meu nome é Arthur.'},
            ...
            dialogue:[
              {speaker:'arthur',text:'Hello! Welcome to this beautiful café!',textPt:'Olá! Bem-vindo a esta linda cafeteria!'},
              {speaker:'Leticia',text:'Hi there! My name is leticia. What\'s your name?',textPt:'Oi! Meu nome é leticia. Qual é o seu nome?'},
              {speaker:'arthur',text:'I\'m Arthur. Nice to meet you, leticia!',textPt:'Eu sou Arthur. Prazer em conhecer você, leticia!'},
              {speaker:'Leticia',text:'Nice to meet you too! How are you today?',textPt:'Prazer em conhecer você também! Como você está hoje?'},
              {speaker:'arthur',text:'I\'m great, thank you! Would you like a coffee?',textPt:'Estou ótimo, obrigado! Você gostaria de um café?'},
            ...
            exercises:[
              ...
              {type:'fill',sentence:'Hello! I ___ Arthur. Nice to ___ you!',blanks:['am','meet'],hints:['verbo to be para I','conhecer']},
          ...
          },
          {
            ...
            dialogue:[
              ...
              {speaker:'arthur',text:'I\'m from London, but I live in São Paulo now.',textPt:'Sou de Londres, mas moro em São Paulo agora.'},
              {speaker:'Leticia',text:'Oh, nice! I\'m from Rio de Janeiro. I\'m Brazilian.',textPt:'Ah, legal! Sou do Rio de Janeiro. Sou brasileira.'},
              {speaker:'arthur',text:'Do you speak English at home?',textPt:'Você fala inglês em casa?'},
              ...
              {speaker:'arthur',text:'That\'s wonderful! Practice makes perfect!',textPt:'Isso é maravilhoso! A prática leva à perfeição!'}
            ],
            pronunciation:[
        ...
        lessons:[
          {
            ...
            dialogue:[
              {speaker:'arthur',text:'Good afternoon! I\'d like to book a room, please.',textPt:'Boa tarde! Eu gostaria de reservar um quarto, por favor.'},
              {speaker:'Leticia',text:'Of course! For how many nights?',textPt:'Claro! Por quantas noites?'},
              {speaker:'arthur',text:'Three nights. From Monday to Thursday.',textPt:'Três noites. De segunda a quinta.'},
              ...
              {speaker:'arthur',text:'How much is that in total?',textPt:'Quanto é isso no total?'},
        ...
        lessons:[
          {
            ...
            dialogue:[
              ...
              {speaker:'arthur',text:'Right this way. Here\'s the menu.',textPt:'Por aqui, por favor. Aqui está o cardápio.'},
              ...
              {speaker:'arthur',text:'Of course. Are you ready to order?',textPt:'Claro. Você está pronta para pedir?'},
              ...
              {speaker:'arthur',text:'Excellent choice! And for dessert?',textPt:'Excelente escolha! E de sobremesa?'},
  ...
  A2: {
    ...
    modules:[
      {id:'a2m1',title:'Travel & Transportation',titlePt:'Viagens e Transporte',icon:'✈️',theme:'Planejando uma viagem internacional',
        lessons:[{
          id:'a2m1l1',title:'Booking a Flight',titlePt:'Reservando um Voo',instructor:'arthur',
          ...
          dialogue:[
            {speaker:'arthur',text:'Excuse me, which gate is flight 247 to London?',textPt:'Com licença, qual portão é o voo 247 para Londres?'},
            {speaker:'Leticia',text:'Gate 12. It\'s boarding in twenty minutes.',textPt:'Portão 12. O embarque começa em vinte minutos.'},
            {speaker:'arthur',text:'Thank you! Do I need to show my passport here?',textPt:'Obrigado! Preciso mostrar meu passaporte aqui?'},
  ...
  B1: {
    ...
    modules:[
      {id:'b1m1',title:'Business English',titlePt:'Inglês para Negócios',icon:'💼',theme:'Reunião de negócios internacional',
        lessons:[{
          id:'b1m1l1',title:'The Business Meeting',titlePt:'A Reunião de Negócios',instructor:'arthur',
          ...
          dialogue:[
            {speaker:'arthur',text:'Good morning, everyone. Shall we begin? Let\'s review today\'s agenda.',textPt:'Bom dia a todos. Podemos começar? Vamos revisar a pauta de hoje.'},
            ...
            {speaker:'arthur',text:'Excellent. Could you walk us through the key drivers?',textPt:'Excelente. Você poderia nos apresentar os principais fatores?'},

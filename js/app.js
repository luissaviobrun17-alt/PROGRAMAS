...
const FreeWorld = (function() {
    ...
    function loadLesson() {
        ...
        const instructor = state.selectedInstructor || 'arthur';
        const isArthur = instructor === 'arthur';
        document.getElementById('instructor-avatar').src = isArthur ? 'assets/images/arthur.png' : 'assets/images/leticia.png';
        document.getElementById('instructor-name').textContent = isArthur ? 'Arthur' : 'Leticia';
    ...
    function renderDialogue(lesson) {
        ...
        lesson.dialogue.forEach((d, i) => {
            const isArthur = d.speaker === 'arthur';
    ...
    function addChatMessage(type, text) {
        ...
        const prefix = type === 'arthur' ? '🎓 Arthur: ' : type === 'Leticia' ? '👩‍🏫 leticia: ' : type === 'system' ? '' : '';
    ...
    function renderRoleplay(lesson) {
        ...
        const instrName = state.selectedInstructor === 'arthur' ? 'Arthur' : 'Leticia';
        const instrImg = state.selectedInstructor === 'arthur' ? 'assets/images/arthur.png' : 'assets/images/leticia.png';
